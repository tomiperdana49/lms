                                ...
                                <div className="space-y-3 pl-0 md:pl-6">
                                    {Array.isArray(q.options) && q.options.map((opt, optIdx) => {
                                        ...
                                        if (showFeedback && qType !== 'POST') {
                                            if (lastScore >= (moduleId ? 100 : 80) || qType === 'PRE') {
                        ...
                        {showFeedback ? (
                            <div className="flex items-center gap-4 flex-1 justify-between w-full">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <button
                                        onClick={() => {
                                            if (lastScore < (moduleId ? 100 : 80) && qType === 'POST') {
                                                setShowFeedback(false);
                                                setQuizAnswers({});
                                            } else {
                                                setShowFeedback(false);
                                                ...
                                                if (lastScore >= 100 && qType === 'POST' && moduleId) {
                                ...
                                <div className="flex gap-3">
                                    ...
                                    {activeModule?.quiz && activeModule.id ? (
                                        ...
                                        <>
                                            ...
                                            {activeModule && (isVideoCompleted || (activeModule.quiz && activeModule.quiz.questions && activeModule.quiz.questions.length > 0 && (quizResults[activeModule.id] || 0) >= 100) || activeModule.completed) && !activeModule.completed && (
