...
const InternalCertificateTemplate: React.FC<InternalCertificateTemplateProps> = ({
    ...
    return (
        ...
        >
            ...
            {/* --- is presented to --- */}
            <div className="absolute z-10 left-0 right-0 text-center" style={{ top: '270px' }}>
            ...
            {/* --- Employee Name --- */}
            <div className="absolute z-10 left-0 right-0 text-center" style={{ top: '306px' }}>
                <span
            ...
            {/* --- Divider --- */}
            <div className="absolute z-10 bg-slate-300" style={{ top: '426px', left: '75px', right: '75px', height: '1px' }} />

            {/* --- Attendance line --- */}
            <div className="absolute z-10 left-0 right-0 text-center px-24" style={{ top: '448px' }}>
            ...
            {/* --- Training Title --- */}
            <div className="absolute z-10 left-0 right-0 text-center px-24" style={{ top: '483px' }}>
            ...
            <div className="absolute z-10 text-center" style={{ top: '524px', left: '140px', right: '140px' }}>
            ...
            <div className="absolute z-10" style={{ top: '624px', left: '75px' }}>
                {qrDataUrl ? (
            ...
            <div className="absolute z-10 space-y-1" style={{ top: '629px', left: '170px' }}>
                {/* "No:" line hidden for now — will be generated by the upcoming certificate-numbering API */}
            ...
            <div className="absolute z-10 text-right" style={{ top: '629px', right: '75px' }}>
